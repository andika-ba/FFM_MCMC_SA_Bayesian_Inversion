...
% and Wallace (1995)
% In this variation, the distance between the seismic station and the eruptive site (d1) is 100
% meters.
...
bounds   = [1E-7 1000 1.00;1E-5 3000 3.00];  % lower-upper limit (boundaries)
Temp     = T_start;      
mcur     = par_init;      % guess/initial values
sd1      = 3.9E-6;          % stepsize for parameter A (related to proposal distribution)
...
toc
save('m_1_0_seismic_intensity_try_hybrid_1900.mat') % save results as a mat file
