...
% and Wallace (1995)
% In this variation, the distance between the seismic station and the eruptive site (d1) is 10
% meters.

v    = 1;              % Magma velocity/upward vertical velocity of the migrating source (m/s)
d1   = 10;             % Distance between the seismic station and the eruptive site (meters)
...
sd1      = 2E-7;       % stepsize for parameter A (related to proposal distribution)
sd2      = 80;            % stepsize for parameter tf (related to proposal distribution)
...
toc
save('d_10_seismic_intensity_try_hybrid_1900.mat') % save results as a mat file
