...
% and Wallace (1995).
% In this variation, we used b-value = 1.0, and smooth the time series using moving median
...
sd1      = 2E-4;          % stepsize for parameter A (related to proposal distribution)
...
toc
save('smooth_b_1_0_seismic_intensity_try_hybrid_1900.mat') % save results as a mat file
