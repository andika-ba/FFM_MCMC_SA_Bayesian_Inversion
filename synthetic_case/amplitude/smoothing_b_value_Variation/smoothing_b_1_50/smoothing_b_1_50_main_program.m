...
% and Wallace (1995)
% In this variation, we used b-value = 1.50, and smooth the time series using moving median
...
toc
save('smooth_b_1_50_seismic_intensity_try_hybrid_1900.mat') % save results as a mat file
