...
% and Wallace (1995).
% In this variation, we used constant earthquake magnitudes (M = 1.0), d = 100 meters, t-end = 1700
% seconds.
...
sd2      = 25;            % stepsize for parameter tf (related to proposal distribution)
...
toc
save('t_1700_seismic_intensity_try_hybrid.mat') % save results as a mat file
