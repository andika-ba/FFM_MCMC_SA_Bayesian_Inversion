...
% and Wallace (1995).
% In this variation, we used constant earthquake magnitudes (M = 1.0), d = 100 meters, t-end = 1800
% seconds.
...
sd1      = 1.1E-6;        % stepsize for parameter A (related to proposal distribution)
...
toc
save('t_1800_seismic_intensity_try_hybrid.mat') % save results as a mat file
