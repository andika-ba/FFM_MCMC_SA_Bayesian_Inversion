...
% and Wallace (1995).
% In this variation, we used constant earthquake magnitudes (M = 1.0), d = 100 meters, t-end = 1500
% seconds.
...
bounds   = [1E-8 1000 1.00;1E-3 4000 3.00];  % lower-upper limit (boundaries)
Temp     = T_start;      
mcur     = par_init;      % guess/initial values
sd1      = 2E-6;          % stepsize for parameter A (related to proposal distribution)
sd2      = 30;            % stepsize for parameter tf (related to proposal distribution)
...
sd1_2         = 1E-9;     % stepsize for parameter A (related to proposal distribution)
...
toc
save('t_1500_seismic_intensity_try_hybrid.mat') % save results as a mat file
