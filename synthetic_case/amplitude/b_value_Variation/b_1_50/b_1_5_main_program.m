...
% generated using Gutenberg - Richter Law with b-value = 1.50.
...
b       = 1.50;           % b-value Gutenberg - Richter Law
...
bounds   = [1E-8 1000 1.00;1E-3 6000 3.00];  % lower-upper limit (boundaries)
Temp     = T_start;      
mcur     = par_init;      % guess/initial values
sd1      = 1E-6;          % stepsize for parameter A (related to proposal distribution)
sd2      = 120;           % stepsize for parameter tf (related to proposal distribution)
...
toc
save('b_1_50_seismic_intensity_try_hybrid_1900.mat') % save results as a mat file
