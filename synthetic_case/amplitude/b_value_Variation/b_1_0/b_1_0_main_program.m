...
% and Wallace (1995)
% In this variation, we used non-constant earthquake magnitudes. The earthquake magnitudes is
% generated using Gutenberg - Richter Law with b-value = 1.0.
...
b       = 1.00;           % b-value Gutenberg - Richter Law
...
bounds   = [1E-8 1000 1.00;1E-2 10000 3.00];  % lower-upper limit (boundaries)
Temp     = T_start;      
mcur     = par_init;      % guess/initial values
sd1      = 2E-3;          % stepsize for parameter A (related to proposal distribution)
...
toc
save('b_1_0_seismic_intensity_try_hybrid_1900.mat') % save results as a mat file
