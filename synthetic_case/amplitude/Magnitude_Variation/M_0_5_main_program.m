...
bounds   = [1E-7 1000 1.00;5E-5 3000 3.00];  % lower-upper limit (boundaries)
Temp     = T_start;      
mcur     = par_init;      % guess/initial values
sd1      = 4E-6;          % stepsize for parameter A (related to proposal distribution)
...
toc
save('m_0_5_seismic_intensity_try_hybrid_1900.mat') % save results as a mat file
