...
tend = 1800;           % Time at the end of seismic amplitude recording (seconds)
...
bounds   = [1E-8 1000 1.00;1E-3 4000 5.00];  % lower-upper limit (boundaries)
Temp     = T_start;      
mcur     = par_init;      % guess/initial values
sd1      = 1E-5;          % stepsize for parameter A (related to proposal distribution)
sd2      = 20;            % stepsize for parameter tf (related to proposal distribution)
...
toc
save('AR_t_1800_seismic_intensity_try_hybrid.mat') % save results as a mat file
