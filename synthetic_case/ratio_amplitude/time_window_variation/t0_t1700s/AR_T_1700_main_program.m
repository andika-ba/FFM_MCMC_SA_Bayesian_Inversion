...
tend = 1700;           % Time at the end of seismic amplitude recording (seconds)
...
sd3      = 0.03;           % stepsize for parameter alpha (related to proposal distribution)
...
toc
save('AR_t_1700_seismic_intensity_try_hybrid.mat') % save results as a mat file
