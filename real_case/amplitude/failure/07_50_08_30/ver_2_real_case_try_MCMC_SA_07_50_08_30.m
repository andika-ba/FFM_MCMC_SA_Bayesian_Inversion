...
idx_final   = (8*3600+(30*60))/10;         % Final time (08:30) 
...
par_init = [10 33000 1.20];   % initial guess
bounds   = [1 29000 1.00;
            100 40000 3.00];  % lower-upper limit (boundaries)
...
toc
save('new_7_50_8_30_real_case_seismic_intensity.mat') % save results as a mat file
