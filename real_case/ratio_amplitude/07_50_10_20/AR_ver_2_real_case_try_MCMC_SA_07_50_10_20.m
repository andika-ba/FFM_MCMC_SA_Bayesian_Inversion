...
sd1_2         = 1E-13;    % stepsize for parameter A (related to proposal distribution)
sd2_2         = 5;       % stepsize for parameter tf (related to proposal distribution)
...
toc
save('AR_7_50_10_20_real_case.mat') % save results as a mat file
