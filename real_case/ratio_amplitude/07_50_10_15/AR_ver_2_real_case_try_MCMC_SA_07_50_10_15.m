...
idx_final   = (10*3600+(15*60))/10;              % Final time (10:15)
...
sd1      = 1E-4;              % stepsize for parameter A (related to proposal distribution)
...
toc
save('AR_7_50_10_15_real_case.mat') % save results as a mat file
