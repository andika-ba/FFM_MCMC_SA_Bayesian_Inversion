function [t_datp,res_10_uv05] = read_sta_UV05(sta_UV05)
% load seismic data;

load(sta_UV05)

test_uv05 = crise(:,2)/(1.4966*800*10^6);  %convert counts to velocity
...
ENV    = abs(hilbert(filtfilt(c,d,filtfilt(a,b,test_uv05)))); % Calculate the envelope
...
idx_1100    = (11*3600+(0*60))/10;         % Final time (08:30) 
res_10_uv05 = res(idx_init:idx_1100);     % Picked data array
